...
class MotionPlanner:
    ...
    def loadMapFromTxt(self,fname):
        ...
        for row_num in range(0,n_rows):
            for col_num in range(0,n_cols):
                ...
                pix_data[row_num, col_num] = float(split_row[col_num])
    ...
    def plotPath(self, tuple_list):
        ...
        plt.pcolor(x,y,map_mat, alpha =0.6 , cmap = 'Reds')    
...
planner.loadMapFromTxt('map_222.csv')
planner.discretizeMap()
# planner.astar((2715, 2372),(2950,2990))
planner.astar((1943.73, 2850.91),(2971.992,2974.772))

# planner.plotMap()
planner.plotDiscretize()
# planner.plotPath([planner.getGrid((2971.992,2974.772))])
# print 'start',planner.getGrid((2199.12708851164, 2184.4718349043787))
# print 'goal', planner.getGrid((5082.75192347869,2184.4718349043787))
print 'start in obstacle_list', planner.getGrid((1943.73, 2850.91)) in planner.obstacle_list
print 'goal in obstacle_list', planner.getGrid((2971.992,2974.772)) in planner.obstacle_list
# planner.plotPath([planner.getGrid((1943.73, 2850.91)),planner.getGrid((2971.992,2974.772))])
planner.plotPath(planner.path)
plt.show()
